...
enum NewsCellType: String {
    case big = "cell_big"
    case horizontal = "cell_horizontal"
    case vertical = "cell_vertical"
}

protocol AppleNewsLayoutDelegate: class
{
    func AppleNewsFlowLayout(_ AppleNewsFlowLayout: AppleNewsLayout, cellTypeForItemAt indexPath: IndexPath) -> NewsCellType
}

class AppleNewsLayout: UICollectionViewFlowLayout {
    
    var maxY: CGFloat = 0.0
    var isVSetOnce = false
    weak var delegate: AppleNewsLayoutDelegate?
